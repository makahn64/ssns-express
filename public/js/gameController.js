...
app.controller("gameController", function($scope, $http, $interval, $timeout ){
    ...
    $scope.refreshLB = function(){
        ...
        $http({method: 'GET', url: '/players/leaderboard'}).
    ...
    $scope.recordWinner = function(player){
        ...
        $http({method: 'POST', url: '/players/winner/'+player.dbid}).
            success(function(data, status, headers, config) {
                console.log("Recorded winner OK!");
            }).
            error(function(data, status, headers, config) {
                console.log("Recorded winner FAILED!");
    ...
    $scope.clearAndExit = function(){
        $http({method: 'POST', url: '/players/clearlb'}).
            success(function(data, status, headers, config) {
                // Skanky way to do this (should be emit) but fuckit. Getting bitwhored to death.
                $scope.$parent.logoClicked();
            }).
            error(function(data, status, headers, config) {
                $scope.$parent.logoClicked();
            });
